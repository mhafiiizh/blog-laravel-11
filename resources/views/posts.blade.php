<x-layout>
  ...
  <div class="py-4 px-4 mx-auto max-w-screen-xl lg:py-8 lg:px-6">
    <div class="mx-auto max-w-screen-md sm:text-center">
      {{-- action dan method boleh tidak ditulis --}}
        ...
        <div
          ...
          <div class="relative w-full">
            ...
            <input
              ...
              placeholder="Search for article" type="search" id="search"
    ...
    <div class="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
      ...
      @empty
        <div class="flex flex-col gap-3">
          <p class="font-semibold text-black-500 dark:text-gray-400">No posts
            found.</p>
          <a href="/posts"
            class="font-medium text-xs text-blue-600 hover:underline">&laquo;
            Back to all post</a>
        </div>
      @endforelse
    </div>
